...
function CreateNewRoom(){
    ...
    return <>
    <div className="bg-[#fab1a0] flex items-center justify-center w-full h-auto px-4 md:px-6 lg:px-8 py-15">
        <div className="text-black relative  w-full flex flex-col items-center justify-center">
            ...
            <h2 className="text-4xl text-black  font-bold  text-center  ">Add New Room</h2>
